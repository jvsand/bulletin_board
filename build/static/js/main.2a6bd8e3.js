/*! For license information please see main.2a6bd8e3.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        function Ll(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Ml(9, jl.bind(null, n, r, a, t), void 0, null),
              null === Ru)
            )
              throw Error(o(349));
            0 !== (30 & hl) || zl(n, t, a);
          ...
          ii = {
            ...
            useSyncExternalStore: function (e, t, n) {
              ...
              return (
                ...
                (r.flags |= 2048),
                Ml(9, jl.bind(null, r, l, n, t), void 0, null),
                n
              );
            },
            useId: function () {
  ...
  !(function () {
    ...
    (function () {
                ...
                t.useCallback(
                  function (t, n) {
                    if ((void 0 === n && (n = {}), u.current))
                      if ("number" !== typeof t) {
                        var o = G(t, JSON.parse(i), l, "path" === n.relative);
                        null == e &&
                          "/" !== r &&
                          (o.pathname =
      ...
      var Se = t.createElement(we, null),
        ke = (function (e) {
          g(r, e);
          var n = k(r);
          function r(e) {
          ...
          t.Children.forEach(e, function (e, a) {
            if (t.isValidElement(e)) {
              ...
              if (e.type !== t.Fragment) {
                ...
                e.props.children && (l.children = Fe(e.props.children, o)),
                  r.push(l);
      ...
      var ft,
        dt =
          ((ft = "undefined" !== typeof Uint8Array && Ve(Uint8Array)),
          function (e) {
        ...
        gt = "0123456789",
        bt = { DIGIT: gt, ALPHA: yt, ALPHA_DIGIT: yt + yt.toUpperCase() + gt };
      var wt = qe("AsyncFunction"),
        St = {
          isArray: Ke,
          isArrayBuffer: Ye,
          isBuffer: function (e) {
          ...
          isThenable: function (e) {
            return e && (et(e) || Ge(e)) && Ge(e.then) && Ge(e.catch);
          },
        };
      ...
      [
        ...
        (kt.from = function (e, t, n, r, a, o) {
          var l = Object.create(Et);
          return (
            St.toFlatObject(
              e,
              l,
      ...
      var Rt = function (e, t, n) {
        ...
        function s(e, n, a) {
          ...
          return !!_t(e) || (t.append(Ot(a, n, o), u(e)), !1);
        }
        var c = [],
          f = Object.assign(Nt, {
            defaultVisitor: s,
                ...
                St.forEach(n, function (n, o) {
                  !0 ===
                    (!(St.isUndefined(n) || null === n) &&
                      a.call(t, n, St.isString(o) ? o.trim() : o, r, f)) &&
                    e(n, r ? r.concat(o) : [o]);
                }),
                c.pop();
            }
      ...
      var It = function (e) {
        function t(e, n, r, a) {
          var o = e[a++],
            ...
            i = a >= e.length;
          return (
            (o = !o && St.isArray(r) ? r.length : o),
            i
              ? (St.hasOwnProp(r, o) ? (r[o] = [r[o], n]) : (r[o] = n), !l)
        ...
        if (St.isFormData(e) && St.isFunction(e.entries)) {
          var n = {};
          return (
            St.forEachEntry(e, function (e, r) {
              t(
                (function (e) {
                  return St.matchAll(/\w+|\[(\w*)]/g, e).map(function (e) {
                    return "[]" === e[0] ? "" : e[1] || e[0];
                  });
                })(e),
                r,
      ...
      var Bt = {
        ...
        transformRequest: [
          function (e, t) {
            var n,
              ...
              o = St.isObject(e);
            if (
              (o && St.isHTMLForm(e) && (e = new FormData(e)), St.isFormData(e))
            )
              return a && a ? JSON.stringify(It(e)) : e;
            if (
              St.isArrayBuffer(e) ||
              St.isBuffer(e) ||
              St.isStream(e) ||
                    ...
                    Object.assign(
                      {
                        visitor: function (e, t, n, r) {
                          return Mt.isNode && St.isBuffer(e)
        ...
        transformResponse: [
          function (e) {
            var t = this.transitional || Bt.transitional,
          ...
          v(
            ...
            [
              {
                ...
                value: function (e, t, n) {
                  ...
                  var o = function (e, t) {
                    return St.forEach(e, function (e, n) {
                      return a(e, n, t);
                    });
                  };
                  return (
                ...
                value: function (e, t) {
                  if ((e = Ht(e))) {
                    ...
                    if (n) {
                      ...
                      if (St.isFunction(t)) return t.call(this, r, n);
                      if (St.isRegExp(t)) return t.exec(r);
                      throw new TypeError(
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    n = {};
                  return (
                    St.forEach(this, function (r, a) {
                      var o = St.findKey(n, a);
            ...
            [
              ...
              },
              {
                key: "accessor",
                value: function (e) {
                  var t = (this[Vt] = this[Vt] = { accessors: {} }).accessors,
                    n = this.prototype;
                  function r(e) {
                    var r = Ht(e);
                    t[r] ||
                      (!(function (e, t) {
                        var n = St.toCamelCase(" " + t);
      ...
      Kt.accessor([
        ...
        St.reduceDescriptors(Kt.prototype, function (e, t) {
          var n = e.value,
      ...
      St.inherits(Gt, Ct, { __CANCEL__: !0 });
      var Zt = Gt;
      var en = Mt.isStandardBrowserEnv
        ? {
      ...
      var nn = Mt.isStandardBrowserEnv
        ? (function () {
            var e,
            ...
            return new Promise(function (t, n) {
              ...
              St.isFormData(o) &&
                (Mt.isStandardBrowserEnv || Mt.isStandardBrowserWebWorkerEnv
                  ...
                  ? St.isString((a = l.getContentType())) &&
                    l.setContentType(
              ...
              if (
                ...
                (s.onabort = function () {
                  s &&
                    (n(new Ct("Request aborted", Ct.ECONNABORTED, e, s)),
                    (s = null));
                }),
                (s.onerror = function () {
                  n(new Ct("Network Error", Ct.ERR_NETWORK, e, s)), (s = null);
                }),
              ...
              void 0 === o && l.setContentType(null),
                "setRequestHeader" in s &&
                  St.forEach(l.toJSON(), function (e, t) {
                ...
                "function" === typeof e.onDownloadProgress &&
                  s.addEventListener("progress", an(e.onDownloadProgress, !0)),
                "function" === typeof e.onUploadProgress &&
                  s.upload &&
                  s.upload.addEventListener("progress", an(e.onUploadProgress)),
                (e.cancelToken || e.signal) &&
                  ((r = function (t) {
                    s &&
                      (n(!t || t.type ? new Zt(null, e, s) : t),
                      s.abort(),
                      (s = null));
                  }),
      ...
      var ln = function (e) {
        ...
        un = function (e) {
          return St.isFunction(e) || null === e || !1 === e;
        },
        sn = function (e) {
          for (
            var t, n, r = (e = St.isArray(e) ? e : [e]).length, a = {}, o = 0;
            o < r;
            o++
          ) {
            var l = void 0;
            if (
              ((n = t = e[o]),
              !un(t) && void 0 === (n = on[(l = String(t)).toLowerCase()]))
            )
              throw new Ct("Unknown adapter '".concat(l, "'"));
            if (n) break;
            a[l || "#" + o] = n;
          }
          if (!n) {
        ...
        return (
          ...
          sn(e.adapter || $t.adapter)(e).then(
            function (t) {
              return (
                cn(e),
                (t.data = Yt.call(e, e.transformResponse, t)),
      ...
      var dn = function (e) {
        return e instanceof Jt ? e.toJSON() : e;
      };
      function pn(e, t) {
        t = t || {};
        var n = {};
            ...
            v(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  var l = o && St.merge(o.common, o[t.method]);
                  o &&
                    St.forEach(
                      [
                        "delete",
              ...
              },
              {
                ...
                value: function (e) {
                  return Dt(
                    tn((e = pn(this.defaults, e)).baseURL, e.url),
                    e.params,
                    e.paramsSerializer,
                  );
                },
        ...
        Sn = (function () {
          function e(t) {
            ...
            this.promise.then(function (e) {
              ...
              t(function (e, t, a) {
                r.reason || ((r.reason = new Zt(e, t, a)), n(r.reason));
              });
          }
          return (
            v(
      ...
      var xn = (function e(t) {
        ...
        return (
          St.extend(r, wn.prototype, n, { allOwnKeys: !0 }),
      ...
      (xn.Axios = wn),
        ...
        (xn.formToJSON = function (e) {
          return It(St.isHTMLForm(e) ? new FormData(e) : e);
        }),
        (xn.getAdapter = sn),
        (xn.HttpStatusCode = En),
        (xn.default = xn);
      var Cn = xn,
        _n = n(184);
      var Pn = function () {
          ...
          return (
            ...
            (0, _n.jsx)("table", {
              children: (0, _n.jsx)("tbody", {
                children: n.map(function (e, t) {
                  var n = t.id;
                  return (0, _n.jsx)(
                    "tr",
                    { children: (0, _n.jsx)("td", { children: e.title }) },
                    n,
                  );
                }),
              }),
        ...
        Rn = function () {
          var e = ve().state,
            ...
            o = (a[0], a[1]),
            l =
              "https://2y6i6tqn41.execute-api.ap-northeast-1.amazonaws.com/threads/".concat(
                n,
                "/posts?offset=0",
              );
          return (
            ...
            (0, _n.jsxs)("div", {
              children: [
                (0, _n.jsxs)("h1", { children: ["title: ", r] }),
                (0, _n.jsxs)("p", { children: ["id:", n] }),
                (0, _n.jsx)("h3", {
                  className: "",
                  children: "\u30b9\u30ec\u30c3\u30c9\u3078\u306e\u6295\u7a3f",
                }),
      ...
      var Tn = function () {
        return (0, _n.jsxs)(Ae, {
          children: [
            ...
            (0, _n.jsxs)(Le, {
              children: [
                (0, _n.jsx)(Re, { path: "/", element: (0, _n.jsx)(On, {}) }),
                (0, _n.jsx)(Re, {
                  path: "/thread/new",
                  element: (0, _n.jsx)(Nn, {}),
                }),
      ...
      (0, a.s)(document.getElementById("root")).render(
        (0, _n.jsx)(t.StrictMode, { children: (0, _n.jsx)(Tn, {}) }),
      );
    })();
})();
//# sourceMappingURL=main.2a6bd8e3.js.map
